...
export interface ApiBusinessBusiness extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::business.business', 'BusinessName'>;
...
export interface ApiCategoreyCategorey extends Schema.CollectionType {
  collectionName: 'categoreys';
  info: {
    singularName: 'categorey';
    pluralName: 'categoreys';
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::categorey.categorey': ApiCategoreyCategorey;
